...
また、この階層にあわせてフォルダに分類分けすることもできます。

さらに、階層分けの方法は、2種類あります。
一つは、ファイルシステムの階層にしたがって階層分けする方法です。
もう一つは、ファイル名の書式にしたがって階層分けする方法です。

*※フォルダへの分類分け機能は、まだ実験段階中です。*
...
.NET Frameworkだよりですが、大きいZIPファイルもストレスなく閲覧できます。
一度にすべて読み込むわけではなく、必要な箇所をある程度まとめてメモリ上に読み込む感じに動作しています。
